...
pair<RigidBody*, PxRigidStatic*> RBTargetGenerator::generateTarget() {
	pair<RigidBody*, PxRigidStatic*> target;
		...
		target = { new RigidBody(position, radius, velocity, rbType.targetRB.life, false, {0.8, 0.8, 0.8, 1}), rigidBStatic };
